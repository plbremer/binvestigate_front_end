...
@app.callback(
    [Output(component_id='table_average_welch',component_property='columns'),
    Output(component_id='table_average_welch',component_property='data'),
    Output(component_id='table_median_mw',component_property='columns'),
    Output(component_id='table_median_mw',component_property='data'),
...
def perform_leaf_query(
    ...
    response=requests.post(base_url+'/leafresource/',json=total_json_output)
    ...
    average_welch_data=total_panda[['compound','fold_average','sig_welch']].to_dict(orient='records')
    # print(average_welch_data)
    median_mw_column_list=[
        {'name':'compound','id':'compound'},{'name':'fold_median','id':'fold_median'},{'name':'sig_mannwhit','id':'sig_mannwhit'},
    ]
    median_mw_data=total_panda[['compound','fold_median','sig_mannwhit']].to_dict(orient='records')
    ...
    return average_welch_column_list,average_welch_data,median_mw_column_list,median_mw_data,volcano_average,volcano_median
