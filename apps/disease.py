...
def callback_aggregate(
    ...
    if (len(callback_context.triggered)>1) and (store_to_disease_data is None):
        ...
        return cytoscape_to_disease_elements, checklist_to_disease_value, dropdown_to_disease_value,store_to_disease_data
        ...
        #elements
        # try:
        #     child_nodes_and_self=nx.algorithms.dag.descendants(networkx_disease,cytoscape_to_disease_tapnodedata['id'])
        # except nx.NetworkXError:
        #     child_nodes_and_self=set()
        # child_nodes_and_self.add(cytoscape_to_disease_tapnodedata['id'])
        # child_nodes_and_self=set(map(str,child_nodes_and_self))
        this_click=set()
